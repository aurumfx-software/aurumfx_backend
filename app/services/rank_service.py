...
def get_team_lots(
    ...
    """
    Get user's complete ACTIVE + APPROVED team lots.
...
def get_direct_sponsor_group_lots(
    ...
    """
    Get ACTIVE direct sponsor groups.

    A direct sponsor counts only when that sponsor
    personally has ACTIVE + APPROVED investment.
    """
...
def check_rank_conditions(
    ...
    """
    Check custom rank group conditions.
    ...
    if not conditions:
        ...
        print("No custom rank conditions.")
...
def get_highest_qualified_rank(
    ...
    """
    Find highest currently qualified rank.
    """
...
def assign_rank(
    ...
    achieved_at is explicitly set to the
    investment approval timestamp.
    ...
    history = UserRankHistory(
        ...
        # IMPORTANT
        achieved_at=approval_timestamp,
    )
...
def credit_rank_reward(
    ...
    All wallet and transaction timestamps use
...
def check_and_assign_rank(
    ...
    `investment` is the investment that triggered
    this rank calculation.

    Its approval_status_updated_at is used for:
    ...
    The user's own ACTIVE + APPROVED investment is
    still checked separately for rank qualification.

    This function DOES NOT commit.
    The investment approval endpoint owns the transaction.
    """
    ...
    if not investment:
        ...
        print(
            "Rank process skipped: Investment not provided"
        )
    ...
    # ======================================================
    # CHECK USER'S OWN ACTIVE + APPROVED INVESTMENT
    # ======================================================
    ...
    active_investment = (
        ...
        .order_by(
            Investment.approval_status_updated_at.desc()
        )
        .first()
    )
    ...
    # NO db.rollback()
    #
    # Approval endpoint owns transaction.
    # ======================================================
